...
<div class="container">
    ...
    <div class=" text-center"><br>
      <img src="{{asset('storage/'.$instrutor->imagem)}}" alt="foto de instrutor" class="rounded-circle fotoaluno img-fluid"/ style="margin:  5px; background-image: url(../img/usuario.png);"><br>
